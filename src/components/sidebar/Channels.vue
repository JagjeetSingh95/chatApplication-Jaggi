<template>
    <div class="cus-channels">
        <div class="channels__container">
            <h4 class="ui inverted center aligned header"><span>Channels </span><i class="plus icon add_channel" @click="openChannelModal"></i></h4>
            ...
            <div class="ui modal" id="channelModal">
                ...
                <div class="content">
                    <div class="ui form" :class="{'error': hasErrors }">
                        <div class="field">
                ...
                <div class="actions">
                    ...
                    <div class="ui cus-color button" @click="addChannel">
                        Add Channel
                    </div>
                </div>
            </div>
